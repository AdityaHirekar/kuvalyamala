...
export default function AskKuvalaya() {
    ...
    return (
        <Section
            id="ask-kuvalaya"
            className={`py-24 border-t relative transition-colors duration-500
                ${isKidsMode
                    ? "bg-sky-100 border-white/50 font-rounded"
                    : "bg-paper border-maroon/10 font-serif"
                }`}
        >
            <div className="max-w-4xl mx-auto">
                ...
                {isKidsMode && !isActive && (
                    ...
                    >
                        <span className="bg-yellow-100 text-orange-600 px-4 py-2 rounded-full text-sm font-bold border-2 border-yellow-300 shadow-sm">
                            👑 Ask Prince Kuvalaya!
                        </span>
                    </motion.div>
                )}
                ...
                {!isActive ? (
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-5xl font-serif font-bold text-ink mb-6">{content.title}</h2>
