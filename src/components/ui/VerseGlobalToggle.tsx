...
export default function VerseGlobalToggle() {
    ...
    return (
        <motion.button
            ...
            className={`fixed top-4 right-16 z-50 p-2.5 rounded-full transition-all duration-300 border backdrop-blur-sm group
                ${showBackgroundVerses
                    ? "bg-paper/80 text-maroon border-maroon/20 hover:bg-maroon hover:text-white"
